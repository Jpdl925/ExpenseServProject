...
const App = () => {
  ...
  // Create a useState to help us handle our selectedCateogies
  ...
  const visibileExpense = selectedCategory ? dummyExpensesArray.filter(e => e.category === selectedCategory) : dummyExpensesArray
  ...
  return (
    ...
    <div className="m-5">
    <ExpenseList expenses={visibileExpense} onDelete={handleDelete}/>
